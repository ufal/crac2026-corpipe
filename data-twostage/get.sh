...
for conf in \
  ...
  minidev:https://ufal.mff.cuni.cz/~mnovak/files/crac26/unc-input_zeropred-minidev.zip \
  minitest:https://ufal.mff.cuni.cz/~mnovak/files/crac26/unc-input_zeropred-minitest.zip
do
  split=${conf%%:*}
  url=${conf#*:}
